# QA Story 911: Stone Age Warrior Production
...
- `test/spex/881_stone_age_warrior_production/criterion_7478_a_city_turns_40_production_into_a_warrior_on_the_map_spex.exs`
- `test/spex/881_stone_age_warrior_production/criterion_7479_a_warrior_walks_one_hex_per_turn_while_a_settler_walks_two_spex.exs`
- `test/spex/881_stone_age_warrior_production/criterion_7480_resting_at_home_heals_garrison_heals_faster_the_road_heals_nothing_spex.exs`
...
Write the brief to `.code_my_spec/qa/911/brief.md` matching this spec exactly.
