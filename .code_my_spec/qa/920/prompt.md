# QA Story 920: Configurable Turn Length
...
- `test/spex/897_configurable_turn_length/criterion_7577_a_fast_world_and_a_slow_world_coexist_spex.exs`
- `test/spex/897_configurable_turn_length/criterion_7578_the_countdown_tells_the_truth_spex.exs`

## Linked component: World

This story is implemented by `BrokenOaths.Worlds.World` (schema).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/broken_oaths/worlds/world_test.exs`
- Spec: `.code_my_spec/spec/broken_oaths/worlds/world.spec.md`
- Source: `lib/broken_oaths/worlds/world.ex`
...
Write the brief to `.code_my_spec/qa/920/brief.md` matching this spec exactly.
