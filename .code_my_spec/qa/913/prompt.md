# QA Story 913: Settler Production and Expansion
...
- `test/spex/883_settler_production_and_expansion/criterion_7486_a_settler_is_paid_for_in_people_spex.exs`
- `test/spex/883_settler_production_and_expansion/criterion_7487_a_hamlet_may_not_empty_itself_onto_the_road_spex.exs`
- `test/spex/883_settler_production_and_expansion/criterion_7488_the_map_remembers_what_the_census_forgets_spex.exs`
- `test/spex/883_settler_production_and_expansion/criterion_7489_the_second_city_is_founded_like_the_first_minus_the_drama_spex.exs`
...
Write the brief to `.code_my_spec/qa/913/brief.md` matching this spec exactly.
