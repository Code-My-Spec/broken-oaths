# QA Story 904: Automatic Turn Processing
...
- `test/spex/874_automatic_turn_processing/criterion_7419_the_countdown_runs_down_and_the_turn_advances_by_itself_spex.exs`
- `test/spex/874_automatic_turn_processing/criterion_7420_the_world_lives_while_everyone_sleeps_spex.exs`
- `test/spex/874_automatic_turn_processing/criterion_7421_a_server_restart_never_loses_or_double-runs_a_turn_spex.exs`
- `test/spex/874_automatic_turn_processing/criterion_7422_nothing_moves_until_the_boundary_then_everything_moves_at_once_spex.exs`
- `test/spex/874_automatic_turn_processing/criterion_7423_two_connected_players_tick_over_together_spex.exs`

## Linked component: TurnBar

This story is implemented by `BrokenOathsWeb.GameLive.TurnBar` (liveview_component).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/broken_oaths_web/live/game_live/turn_bar_test.exs`
- Spec: `.code_my_spec/spec/broken_oaths_web/game_live/turn_bar.spec.md`
- Source: `lib/broken_oaths_web/live/game_live/turn_bar.ex`
...
Write the brief to `.code_my_spec/qa/904/brief.md` matching this spec exactly.
