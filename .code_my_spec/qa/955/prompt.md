...
As a player, once I've researched Writing, I want to build a Library in my cities, so that research feels rewarding and my science income grows.
...
Write the brief to `.code_my_spec/qa/955/brief.md` matching this spec exactly.
