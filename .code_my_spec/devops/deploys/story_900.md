...
- **QA basis**: story 900 has a passing DB-backed QA attempt (batch-4 QA phase, 2026-07-18); all medium+ issues found during QA are resolved. Prod promotion completed in the same release (https://broken-oaths.com /health 200; dev-only /dev/qa routes confirmed 404 in prod).
