defmodule BrokenOathsWeb.AccountLive.Index do
  use BrokenOathsWeb, :live_view

  alias BrokenOaths.Accounts
  alias BrokenOaths.Accounts.Account
  ...
  def mount(_params, _session, socket) do
    ...
    Phoenix.PubSub.subscribe(BrokenOaths.PubSub, "accounts:#{current_scope.user.id}")
