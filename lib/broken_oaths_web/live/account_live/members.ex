defmodule BrokenOathsWeb.AccountLive.Members do
  use BrokenOathsWeb, :live_view

  alias BrokenOaths.Accounts
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    case Accounts.get_account(current_scope, id) do
      ...
      account ->
        ...
        Phoenix.PubSub.subscribe(BrokenOaths.PubSub, "account:#{account.id}")
        Phoenix.PubSub.subscribe(BrokenOaths.PubSub, "account_members:#{account.id}")
