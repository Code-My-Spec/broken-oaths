defmodule BrokenOaths.Integrations.Integration do
  use Ecto.Schema
  import Ecto.Changeset

  alias BrokenOaths.Encrypted.Binary
  ...
  @providers Application.compile_env(:broken_oaths, :integration_providers, [:github])
