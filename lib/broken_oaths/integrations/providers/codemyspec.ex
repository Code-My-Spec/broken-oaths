defmodule BrokenOaths.Integrations.Providers.Codemyspec do
  @moduledoc """
  ...
  @impl true
  def config do
    base_url = Application.fetch_env!(:broken_oaths, :codemyspec_url)
    client_id = Application.fetch_env!(:broken_oaths, :codemyspec_client_id)
    client_secret = Application.fetch_env!(:broken_oaths, :codemyspec_client_secret)
    redirect_uri = BrokenOathsWeb.Endpoint.url() <> @callback_path
