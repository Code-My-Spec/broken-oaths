defmodule BrokenOaths.Integrations.Providers.Google do
  @moduledoc """
  ...
  @impl true
  def config do
    client_id = Application.fetch_env!(:broken_oaths, :google_client_id)
    client_secret = Application.fetch_env!(:broken_oaths, :google_client_secret)
