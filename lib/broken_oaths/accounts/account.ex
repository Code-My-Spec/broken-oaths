defmodule BrokenOaths.Accounts.Account do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          slug: String.t() | nil,
          members: [BrokenOaths.Accounts.Member.t()] | Ecto.Association.NotLoaded.t(),
          users: [BrokenOaths.Users.User.t()] | Ecto.Association.NotLoaded.t(),
  ...
  schema "accounts" do
    ...
    has_many :members, BrokenOaths.Accounts.Member, on_delete: :delete_all
