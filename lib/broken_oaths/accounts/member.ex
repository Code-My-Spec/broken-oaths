defmodule BrokenOaths.Accounts.Member do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          user: BrokenOaths.Users.User.t() | Ecto.Association.NotLoaded.t(),
          account: BrokenOaths.Accounts.Account.t() | Ecto.Association.NotLoaded.t(),
  ...
  schema "members" do
    ...
    belongs_to :user, BrokenOaths.Users.User
    belongs_to :account, BrokenOaths.Accounts.Account, type: :binary_id
