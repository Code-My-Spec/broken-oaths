defmodule BrokenOaths.Feudal.Levy do
  @moduledoc """
  ...
  early; `BrokenOaths.Feudal.Tribute` is where a mid-war withdrawal gets
  ...
  `BrokenOaths.Feudal.Tribute`'s own (`issue_changeset/5`,
