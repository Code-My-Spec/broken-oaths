defmodule BrokenOaths.Feudal.OathStrain do
  @moduledoc """
  The canonical Oath Strain math (story 913, `:feudal_enabled`) —
  liberty pressure, 0-100, per `BrokenOaths.Feudal.Vassalage.oath_strain`
  ...
  * `spike_refused_levy/1` — a moderate, one-time spike
    ...
    arms — deliberately the SAME magnitude `BrokenOaths.Feudal.Tribute`
