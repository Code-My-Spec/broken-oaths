defmodule BrokenOaths.Feudal.Rebellion.War do
  @moduledoc """
  ...
  `BrokenOaths.Feudal.Vassalization.maybe_revassalize/3`, restoring) the
  ...
  `maybe_revassalize/3` lives on `BrokenOaths.Feudal.Vassalization`
