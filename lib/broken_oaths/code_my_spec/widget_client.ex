defmodule BrokenOaths.CodeMySpec.WidgetClient do
  @moduledoc """
  ...
  defp build_uri(user_id, user_email) do
    base = Application.get_env(:broken_oaths, :codemyspec_widget_url)
    deploy_key = Application.get_env(:broken_oaths, :deploy_key)
