defmodule BrokenOaths.Game.RebellionPact.Conspiracy do
  @moduledoc """
  ...
  through the SAME `BrokenOaths.Game.Rebellion.War.declare_independence/3`
  ...
  `BrokenOaths.Game.Rebellion.War.declare_independence/3` the immediate
