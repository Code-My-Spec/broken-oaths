defmodule BrokenOaths.Vision.Visibility do
  ...
  defp format_unit(state, unit, viewer_player_id) do
    ...
    %{
      ...
      # Story 920 — the Fortify stance's own turns-held counter (0 not
      # fortified, 1 partial, 2+ full — see `Units.Unit`'s own
      # "fortified_turns" moduledoc paragraph): public knowledge like
