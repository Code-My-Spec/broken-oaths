defmodule BrokenOaths.Feudal do
  @moduledoc """
  ...
  eases their Oath Strain (`BrokenOaths.Feudal.OathStrain.ease_gift/1`).
  """
  ...
  (`BrokenOaths.Feudal.OathStrain.ease_shared_enemy/1`).
  """
  ...
  `BrokenOaths.Feudal.Rebellion.Resolution.city_rises?/4` (the SAME
  deterministic formula `declare_independence/3` itself commits with),
  plus the predicted temporary army size
  (`BrokenOaths.Feudal.Rebellion.Resolution.army_size/1`). Never live RNG,
  ...
  to them (`BrokenOaths.Feudal.Rebellion.Resolution.resolve_risings/4`) —
  ...
  a temporary rebellion army (`BrokenOaths.Feudal.Rebellion.Resolution.
  ...
  persisted, first-class `BrokenOaths.Feudal.Rebellion` row (`status:
  ...
  time (`BrokenOaths.Feudal.Rebellion`'s own moduledoc).
  """
  ...
  7742): the mean `BrokenOaths.Feudal.Vassalage.oath_strain` across
  ...
  `BrokenOaths.Feudal.OathStrain.gift_ease/0` at once — a broad
  ...
  `BrokenOaths.Feudal.OathStrain.autonomy_ease/0` — a targeted
  ...
  @doc "`user`'s own bank status: `%{gold:, cap:}` (`BrokenOaths.Feudal.Bank.status/1`)."
  ...
  @doc "Raise `user`'s own bank cap for `BrokenOaths.Feudal.Bank.upgrade_cost/1`'s own gold price — refused outright when unaffordable."
  ...
  (`BrokenOaths.Feudal.Stewardship.eligible?/1`), AND `owner_user_id` is
  ...
  `BrokenOaths.Feudal.Stewardship.under_attack?/1`. An eligible steward
